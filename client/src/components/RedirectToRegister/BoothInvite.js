  ...
  return (
    <>
      <Paper className="py-2">
        <NormalText>
          You have been invited as a Booth exhibitor for this event.
        </NormalText>{" "}
        ...
        <Grid className="p-3">
          ...
          <div className="p-4">
            ...
            <Announcement className="mb-3">
              You have been invited as a Booth exhibitor for this event. Please create an
...
export default BoothEventInvite;
