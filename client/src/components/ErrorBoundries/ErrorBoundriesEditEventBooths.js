...
import { errorTrackerForFetchBooths } from "../../actions";
// import { errorTrackerForFetchEventsOfParticularCommunity } from "../../actions";
class ErrorBoundaryEditEventBooths extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidCatch(error, errorInfo) {
    ...
    this.props.errorTrackerForFetchBooths();
