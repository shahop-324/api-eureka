...
import { errorTrackerForFetchRegistrationsOfParticularEvent } from "../../actions";
// import { errorTrackerForFetchEventsOfParticularCommunity } from "../../actions";
class ErrorBoundaryRegistrations extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidCatch(error) {
    ...
    this.props.errorTrackerForFetchRegistrationsOfParticularEvent();
