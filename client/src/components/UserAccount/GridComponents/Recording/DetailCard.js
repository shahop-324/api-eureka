  ...
  return (
    ...
    <div className="registrations-list-fields-container">
      <div className="registrations-name-field" style={{justifySelf: "start"}}>
        <ListFieldsStyled className=" mx-5">Protecting your digital assets</ListFieldsStyled>
      </div>
      <div className="registrations-email-field">
        <ListFieldsStyled className="">Cybersecurity Conference 21</ListFieldsStyled>
      </div>
      <div className="registrations-phone-field">
        <ListFieldsStyled className="">2hr 24min</ListFieldsStyled>
      </div>
      <div className="registrations-amount-field">
        <ListFieldsStyled className=""><FourKIcon style={{fill: "#152d35", fontSize: "32"}} /></ListFieldsStyled>
      </div>
      <div className="registrations-ticket-type-field">
        <ListFieldsStyled className=""><PlayCircleOutlineRoundedIcon style={{fill: "#E73737", fontSize: "32"}}/></ListFieldsStyled>
      </div>
      <div className="registrations-invoice-field">
        <ListFieldsStyled className=""><CloudDownloadIcon style={{fill: "#152d35", fontSize: "32"}} /></ListFieldsStyled>
      </div>
    </div>
    <div className="my-3">
        <Divider />
