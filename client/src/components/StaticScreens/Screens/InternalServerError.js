...
<div className="container-error">
	<div className="left-section">
		<div className="inner-content">
			...
			<p className="subheading">Looks like something is wrong on our server side, we are working on it.</p>

            <div className=" mt-5" style={{ textAlign: "center" }}>
              <a href='/home' className="btn btn-primary btn-outline-text btn-attention-home px-5 py-3">
                Back to home
              </a>
            </div>
		</div>
