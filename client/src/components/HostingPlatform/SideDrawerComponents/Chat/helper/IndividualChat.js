      ...
      <div className="individaul-chat-container">
        ...
        <div className="d-flex flex-row align-items-center mb-4">
          <div
            ...
            className="px-2 py-1"
          >
            <ArrowBackIosRoundedIcon style={{ fontSize: "18px" }} />
          </div>
          <div className="ms-3" style={{ color: "#212121", fontWeight: "500", fontSize: "0.9rem" }}>
            Back
          </div>
        </div>
        ...
        <div className="individual-chat-summary-container mb-2 px-3 ">
          ...
          <div className="">
            ...
            {status === "active" ? (
              <div
                ...
                style={{ color: "#75BF72", fontFamily: "Ubuntu", fontSize: "0.8rem" }}
              >
                <Ripple /> Active{" "}
              </div>
            ) : (
          ...
          <div style={{ justifySelf: "end" }}>
              <InfoOutlinedIcon className="chat-msg-hover-icon"/> 
...
<div>
    <hr/>
        ...
        <div className="chat-msg-container pt-2 px-2 d-flex flex-column justify-content-between" style={{height: "63vh"}}>
        <div
