...
const GroupMeetDetails = ({ openDrawer, handleCloseDrawer }) => {
  return (
    <>
      <React.Fragment key="right">
        ...
        >
          <div className="group-meet-details-container px-4 py-2">
            ...
            <div className="btn-outline-text mb-4">Who's Invited ?</div>

            <div className="session-speakers-list-grid mb-4">
              <SessionSpeakerCard
                image={Faker.image.avatar()}
                name={Faker.name.findName()}
                headline={"Product Manager, Evenz"}
              />
              <SessionSpeakerCard
                image={Faker.image.avatar()}
                name={Faker.name.findName()}
...
export default GroupMeetDetails;
