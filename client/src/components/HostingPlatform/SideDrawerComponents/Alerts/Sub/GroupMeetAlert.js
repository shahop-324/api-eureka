...
import GroupMeetDetails from "./GroupMeetDetails";

const GroupMeetAlert = () => {
    ...
    <>
      <div className="general-alert-container px-4 py-3 mb-3">
        ...
        <div className="alert-text mb-3">
          Invited you to group meet <b> Batch 2022 </b>
        </div>
      ...
      <GroupMeetDetails openDrawer={open} handleCloseDrawer={handleClose}/>
    </>
  );
};

export default GroupMeetAlert;
