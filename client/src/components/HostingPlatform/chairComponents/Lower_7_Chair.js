...
const LOWER_7_CHAIR = ({ id, launchTableScreen }) => {
  ...
  const chair = useSelector((state) => state.rooms.chairs.find((chair) => {
    return (chair && chair.chairId ? (chair.chairId === `${id}_chair_7` && chair.status === "Occupied" ? chair  : null) : null);
   }) );
   ...
   if (chair) {
     ...
     userImage7 = `https://evenz-img-234.s3.ap-south-1.amazonaws.com/${chair.userImage}`;
                  ...
                  <div style={{display: displayPopUp}}>
                    <div className="d-flex flex-row align-items-center" style={{display: displayPopUp}}>
                      ...
                      <div className="ms-3" style={{display: displayPopUp}}>
                        ...
                        <div className="people-location" style={{display: displayPopUp}}>{userCity7}, {userCountry7}</div>
                      </div>
                    </div>
                  </div>
                </Popup>
