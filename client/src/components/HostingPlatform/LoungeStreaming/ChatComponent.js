...
import { fetchTableChats, updateTableChats } from "./../../../actions"; // This will fetch all previous chats of this table
...
const ChatComponent = ({ tableId }) => {
  ...
  const tableChats = useSelector((state) => state.rooms.tableChats);
