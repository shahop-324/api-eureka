...
import SlidoEnable from "./Forms/SlidoEnable";
import Button from "@mui/material/Button";
import UninstallSlido from "./Uninstall/UninstallSlido";
...
const Slido = () => {
  ...
  return (
    <>
        ...
        >
          ...
          <div>
            ...
            <div className="integration-short-description">
              Make audience interaction easy with slido live QnA, Poll and
              Surveys
            </div>
          </div>
          ...
          >
            ...
            {communityDetails.isConnectedSlido ? (
              <button
                onClick={() => {
      ...
      <SlidoEnable openDrawer={open} handleCloseDrawer={handleClose} />
      <UninstallSlido open={openUninstall} handleClose={handleCloseUninstall} />
    </>
  );
};
