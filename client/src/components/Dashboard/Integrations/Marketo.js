    ...
    <>
      <div className="integration-card-container px-4 py-3 mb-4">
        ...
        >
          ...
          />
          <div>
            <div className="integration-name mb-3">
              <span className="me-3">Marketo</span>
              <Chip
                label="Via zapier"
                color="info"
                variant="outlined"
            ...
            <div className="integration-short-description">
              Boost your event marketing with powerful tools built into marketo
              by integrating with Evenz.
            </div>
          </div>
