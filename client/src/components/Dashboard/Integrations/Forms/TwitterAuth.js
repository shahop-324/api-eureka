...
import TwitterIntegrationPNG from "./../../../../assets/images/int-7.png";
const { REACT_APP_MY_ENV } = process.env;
const BaseURL = REACT_APP_MY_ENV
  ? "http://localhost:3000/api-eureka/eureka/v1"
  : "https://www.evenz.co.in/api-eureka/eureka/v1";
const TwitterAuth = ({ openDrawer, handleCloseDrawer }) => {
  return (
    <>
            ...
            <div>
              ...
              <div>
                ...
                <div className="integration-guide-btn px-4 py-2">
                  Guide to Integrate Twitter with Evenz.
                </div>
              </div>
            </div>
          </div>
