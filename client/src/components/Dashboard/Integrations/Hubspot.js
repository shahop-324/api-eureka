...
import UninstallHubspot from "./Uninstall/UninstallHubspot";
...
const Hubspot = () => {
  ...
  return (
    <>
      <div className="integration-card-container px-4 py-3 mb-4">
        ...
        >
          ...
          >
            ...
            {communityDetails.isConnectedHubspot ? (
              <button
                onClick={() => {
      ...
      <UninstallHubspot open={openUninstall} handleClose={handleCloseUninstall} />
    </>
  );
};
