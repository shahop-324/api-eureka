...
const BuyExtraStreamingHours = ({ open, handleClose }) => {
      ...
      >
        <div className="" style={{ width: "520px" }}>
          <HeaderFooter className="p-3">
            <Heading className="">Additional Streaming Hours</Heading>
          </HeaderFooter>
          ...
          >
            <div className="mb-3 overlay-form-input-row">
              ...
              >
                How many extra streaming hours do you need ?
              </FormLabel>
          ...
          <div className="d-flex flex-row align-items-center justify-content-end px-4 pb-4">
            ...
            >
              Pay{" "}
              {value && !value * 1 <= 0 ? `$${(value * 35.99).toFixed(2)}` : null}
            </button>
          </div>
        </div>
      </Dialog>
...
export default BuyExtraStreamingHours;
