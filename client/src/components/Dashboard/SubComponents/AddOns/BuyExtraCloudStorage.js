...
const BuyExtraCloudStorage = ({ open, handleClose }) => {
      ...
      >
        <div className="" style={{ width: "520px" }}>
          <HeaderFooter className="p-3">
            <Heading className="">Additional Cloud Storage</Heading>
          </HeaderFooter>
          ...
          >
            <div className="mb-3 overlay-form-input-row">
              ...
              >
                How much extra cloud storage do you need (in GB) ?
              </FormLabel>
          ...
          <div className="d-flex flex-row align-items-center justify-content-end px-4 pb-4">
            ...
            >
              Pay{" "}
              {value && !value * 1 <= 0 ? `$${(value * 1.599).toFixed(2)}` : null}
            </button>
          </div>
        </div>
      </Dialog>
...
export default BuyExtraCloudStorage;
