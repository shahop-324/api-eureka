...
const BuyExtraOrganiser = ({ open, handleClose }) => {
      ...
      >
        <div className="" style={{ width: "520px" }}>
          <HeaderFooter className="p-3">
            <Heading className="">Additional Organisers</Heading>
          </HeaderFooter>
          ...
          >
            <div className="mb-3 overlay-form-input-row">
              ...
              >
                How many extra organiser seats you want to add ?
              </FormLabel>
          ...
          <div className="d-flex flex-row align-items-center justify-content-end px-4 pb-4">
            ...
            >
              Pay{" "}
              {value && !value * 1 <= 0 ? `$${(value * 49.99).toFixed(2)}` : null}
            </button>
          </div>
        </div>
      </Dialog>
...
export default BuyExtraOrganiser;
