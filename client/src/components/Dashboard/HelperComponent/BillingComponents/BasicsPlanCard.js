  ...
  const displayRazorpay = async () => {
    ...
    let order = await fetch(
      "http://localhost:3000/eureka/v1/razorpay/createCommunityPlanOrder",
      {
        method: "POST",
        body: JSON.stringify({
          selectedPlanId: "PLAN_EVENZ_001Basics",
  ...
  return (
    <>
      <div className="pricing-plan-card p-4">
        <div className="pricing-plan-name mb-3">Basics</div>
        <div className="d-flex flex-row align-items-center">
          <div className="original-plan-price-value me-3">$99</div>
          <div className="original-plan--reduced-price-value me-1">$79 /</div>
