...
import EditStreamInBluemeet from "../../../FormComponents/EditSessionForms/EditStreamInBluemeet";
...
const StreamInBluemeetDetailCard = ({
  endTime,
  startTime,
  name,
  startDate,
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div
                className="referral-link-and-copy-to-clipboard mb-3"
                style={{ textAlign: "center" }}
              >
                <div className="ui action input" style={{ minWidth: "300px" }}>
                  <input
                    type="text"
                    value={"stream key"}
                    readOnly
      ...
      {/*  */}
      {/*  */}
      <EditStreamInBluemeet open={open} handleClose={handleClose} id={id} />
      <DeleteSession
...
export default StreamInBluemeetDetailCard;
