  ...
  return (
    <>
      <div
        ...
        id={id}
        style={{ gridTemplateColumns: "2fr 2fr 3fr 1.5fr", gridGap: "32px" }}
      >
        <div
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* {description} */}
              Speakers and participants needs to be matched.
            </div>
          </div>
        </div>
      ...
      <EditNetworking open={open} handleClose={handleClose} id={id} />
      <DeleteSession
