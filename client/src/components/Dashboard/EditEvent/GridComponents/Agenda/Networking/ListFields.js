...
const NetworkingListFields = () => {
  return (
      <>
    <div className="session-list-fields-container" style={{gridTemplateColumns: "2fr 2fr 3fr 1.5fr", gridGap: "32px"}}>
      ...
      <div className="event-visibility-field">
        <div className="event-field-label" style={{width: '100%'}}>Matching rules</div>
      </div>
...
export default NetworkingListFields;
