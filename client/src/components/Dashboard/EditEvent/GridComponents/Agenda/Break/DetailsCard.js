...
import EditBreak from "../../../FormComponents/EditSessionForms/EditBreak";
...
const BreakDetailCard = ({
  ...
  return (
    <>
      ...
      {/*  */}
      <EditBreak open={open} handleClose={handleClose} id={id} />
      <DeleteSession
...
export default BreakDetailCard;
