  ...
  return (
    <>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            You are about to delete this stream destination. By doing so, this
            destination won't be available for streaming in any sessions. But
            the one already streaming on this one will have to pause and
...
export default DeleteStreamDestination;
